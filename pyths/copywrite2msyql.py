...
def main():
    ...
    ### newway
    NFFT = 512; N = NFFT; n = np.arange(N); Fs = 8000.
    window = hann(NFFT) #Magnitude (normalized to 0dB)
    x = []
    for i in n:
        x.append(0.4*sin(2*pi*500/Fs*i) + 0.6*sin(2*pi*1000/Fs*i))
